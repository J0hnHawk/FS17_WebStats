	...
	<div class="container">
		...
		<div id="navbar" class="collapse navbar-collapse">
			<ul class="nav navbar-nav">
				<li class="{if $page == 'status'}active{/if}"><a
					href="index.php?page=status"> <span
						class="glyphicon glyphicon-home"></span> Serverübersicht
				</a></li>
				<li class="{if $page == 'storage'}active{/if}"><a
					href="index.php?page=storage"> <span
						class="glyphicon glyphicon-stats"></span> Lagerbestände
				</a></li>
				<li class="{if $page == 'production'}active{/if}"><a
					href="index.php?page=production"> <span
						class="glyphicon glyphicon-list"></span> Produktionsanlagen
				</a></li>
			</ul>
			<ul class="nav navbar-nav navbar-right">
				<li class="{if $page == 'options'}active{/if}"><a href="index.php?page=options"> <span class="glyphicon glyphicon-cog"></span> Einstellungen</a></li>
				<li><a href="#" data-toggle="modal" data-target="#infoModal"> <span
